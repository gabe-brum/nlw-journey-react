...
export function DestinationAndDateHeader() {
  ...
  function renderUpdateTripModal() {
    if (!isUpdateTripModalOpen) return null;

    return <UpdateTripModal closeUpdateTripModal={closeUpdateTripModal} />;
  }
